      ...
      <Card className="border border-gray-200 bg-white shadow-none">
        <CardContent className="py-4">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
            <div>
              <p className="mb-1 text-xs text-gray-400">Categorías</p>
            ...
            <div>
              <p className="mb-1 text-xs text-gray-400">En uso</p>
              <p className="text-sm font-semibold text-gray-900">
                {usedCategories}
              </p>
            </div>
          ...
          {categories.length === 0 ? (
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
              {categories.map((category) => (
                <div
                  key={category.id}
                  className="flex items-center justify-between rounded-2xl border border-gray-100 bg-white px-4 py-4 transition-all duration-200 hover:border-gray-200 hover:bg-gray-50/70"
                >
