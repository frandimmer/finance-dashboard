    ...
    <Sheet open={open} onOpenChange={handleOpenChange}>
      <SheetTrigger asChild>
        {isEditing ? (
          <button
            type="button"
            className="inline-flex h-8 w-8 items-center justify-center rounded-xl text-gray-400 transition-colors hover:bg-blue-50 hover:text-blue-500 dark:text-gray-500 dark:hover:bg-blue-500/10 dark:hover:text-blue-400"
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-xs text-gray-400 dark:text-gray-500">
                  Si el mes no tiene ese día, se registra el último día
                  disponible.
                </p>
              </div>
                ...
                {categories.length === 0 ? (
                  <div className="rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-900">
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Podés crear el recurrente sin categoría y asignarla
                      después.
                    </p>
                  </div>
                ) : (
