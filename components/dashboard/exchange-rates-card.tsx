...
export function ExchangeRatesCard({ rates }: ExchangeRatesCardProps) {
  ...
  return (
    <motion.div
      ...
      className="w-full overflow-hidden rounded-2xl border border-gray-200 bg-white text-xs shadow-sm sm:w-80"
    >
      <button
        type="button"
      ...
      >
        <div>
          <p className="font-semibold text-gray-700">Cotizaciones USD</p>
          <p className="mt-0.5 text-gray-400">Blue · MEP · Oficial</p>
        </div>
