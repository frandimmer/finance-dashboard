            ...
            <div className="grid grid-cols-1 gap-3 xl:grid-cols-2">
              {data.budgets.map((budget) => {
                ...
                return (
                  <div
                    key={budget.id}
                    className="rounded-2xl border border-gray-100 bg-white p-4 transition-all duration-200 hover:border-gray-200 hover:bg-gray-50/70 dark:border-gray-800 dark:bg-gray-950/40 dark:hover:border-gray-700 dark:hover:bg-gray-800/60"
                  >
